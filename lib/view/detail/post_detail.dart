...
class _PostingDetailScreenState extends State<PostingDetailScreen>
  ...
  final TextEditingController replyChangeController = TextEditingController();
  final FocusNode replyChangeFocusNode = FocusNode();
  ...
  void dispose() {
    ...
    replyChangeController.dispose();
    replyChangeFocusNode.dispose();
                                      ...
                                      if (postDetailData['category'] == 'i') {
                                        Navigator.pushNamed(
                                          ...
                                          arguments: {
                                            ...
                                            'post_category':
                                                postDetailData['post_category'],
                                          },
                                        );
                                      } else if (postDetailData['category'] ==
                                              'g' ||
                                          postDetailData['category'] == 'y') {
                                        Navigator.pushNamed(
                                          context,
                                          '/writing',
                                          arguments: {
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            child: Column(
                              children: [
                                // 업로드 사용자 프로필 이미지, 닉네임, 업로드 시간, label, badge, 타이틀, 내용등
                                Padding(
                                  padding: const EdgeInsets.symmetric(
                                      horizontal: 20.0),
                                  child: Row(
                                ...
                                postDetailData['gift'].isNotEmpty
                                    ...
                                    : Container(),
                                // 이미지
                                postDetailData['category'] != null &&
                                        postDetailData['category'] == 'i'
                                    ? InkWell(
                                        onTap: () {
                                          Navigator.push(
                                              context,
                                            ...
                                            return Container(
                                              ...
                                              margin: dots ==
                                                  ...
                                                  : const EdgeInsets.only(
                                                      right: 10.0),
                                              decoration: BoxDecoration(
                                                color: currentPage == dots
                                                    ? ColorsConfig().primary()
                                                    : ColorsConfig.defaultToast,
                                                borderRadius:
                                                    BorderRadius.circular(4.0),
                                              ),
                                            );
                                    ...
                                    TextSpan(
                                        children: List.generate(
                                            postDetailData['description']
                                                ...
                                                .length, (index) {
                                      return TextSpan(
                                        text: postDetailData['description']
                                                    .toString()
                                                    .split('\n')
                                                    .length !=
                                                index + 1
                                            ...
                                            : postDetailData['description']
                                                ...
                                                .split('\n')[index],
                                        style: TextStyle(
                                          color: postDetailData['description']
                                                      .toString()
                                                      .split('\n')[index]
                                                      .startsWith('http://') ||
                                                  postDetailData['description']
                                                                    ...
                                                                    onTap: () {
                                                                      if (timeLineReplyData[
                                                                        ...
                                                                        Navigator.pushNamed(
                                                                            ...
                                                                            '/your_profile',
                                                                            arguments: {
                                                                              'user_index': timeLineReplyData[index]['user_index'],
                                                                              'user_name': timeLineReplyData[index]['nick'],
                                                                            });
                                                                      }
                                                                    },
                                                                    child: Row(
                                                                      ...
                                                                      children: [
                                                                        InkWell(
                                                                          ...
                                                                          child:
                                                                              Container(
                                                                            padding:
                                                                                const EdgeInsets.symmetric(horizontal: 13.5, vertical: 8.5),
                                                                            decoration:
                                                                                BoxDecoration(
                          ...
                          if (useSort)
                            Column(
                              children: List.generate(recentlyReplyData.length,
                                  (index) {
                                return Column(
                                  children: [
                                    // 댓글 원본 영역
                                                                    ...
                                                                    showModalBottomSheet(
                                                                      ...
                                                                      if (_val[
                                                                        ...
                                                                        DeleteReplyDataAPI()
                                                                            .deleteReply(
                                                                                accesToken: _prefs.getString('AccessToken')!,
                                                                                replyIndex: recentlyReplyData[index]['reply_index'],
                                                                                isParent: 1)
                                                                            .then((_v) {
                                                                          setState(
                                                                              () {
                                                                            recentlyReplyData[index]['type'] =
                                                                                0;
                                                                            recentlyReplyData[index]['message'] =
                                                                                '삭제 된 메시지입니다.';
                                                                          });
                                                                  ...
                                                                  Row(
                                                                    children: [
                                                                      Container(
                                                                        ...
                                                                        child:
                                                                            CustomTextBuilder(
                                                                          text: recentlyReplyData[index]['child'][subIndex]
                                                                              [
                                                                              'parent_nick'],
                                                                          fontColor:
                                                                              ColorsConfig().textWhite1(),
                                                                      ...
                                                                      CustomTextBuilder(
                                                                        text: DateCalculatorWrapper().daysCalculator(recentlyReplyData[index]['child'][subIndex]
                                                                            [
                                                                            'reg_dt']),
                                                                        fontColor:
                                                                            ColorsConfig.defaultGray,
                                                              ...
                                                              Container(
                                                                margin:
                                                                    const EdgeInsets
                                                                        ...
                                                                        bottom:
                                                                            10.0),
                                                                child: recentlyReplyData[index]['child'][subIndex]
                                                                            [
                                                                            'type'] ==
                                                                        0
                                                                    ? Text.rich(
                                                                    ...
                                                                    : Column(
                                                                        ...
                                                                        children: [
                                                                          CustomTextBuilder(
                                                                            text:
                                                                                '[${recentlyReplyData[index]['child'][subIndex]['parent_nick']} > ${recentlyReplyData[index]['child'][subIndex]['child_nick']}]',
                                                                            style:
                                                                                TextStyle(
                                                                              color: ColorsConfig().textBlack2(),
                                                                              fontSize: 16.0.sp,
                                                      ...
                                                      children: [
                                                        ...
                                                        MaterialButton(
                                                          onPressed: () async {
                                                            ...
                                                            if (recentlyReplyData[index]['child']
                                                                            [
                                                                            subIndex]
                                                                        [
                                                                        'isLike'] ==
                                                              ...
                                                              AddReplyLikeDataAPI()
                                                                ...
                                                                accesToken: _prefs
                                                                    .getString(
                                                                        'AccessToken')!,
                                                                replyIndex: recentlyReplyData[index]
                                                                            [
                                                                            'child']
                                                                        [
                                                                        subIndex]
