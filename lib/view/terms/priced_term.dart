...
class PricedTermDetailScreen extends StatefulWidget {
  const PricedTermDetailScreen({Key? key}) : super(key: key);

  @override
  State<PricedTermDetailScreen> createState() => _PricedTermDetailScreenState();
}

class _PricedTermDetailScreenState extends State<PricedTermDetailScreen> {
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: CustomTextBuilder(
                          text: 'DR-Public 유료서비스 이용약관',
                          fontColor: ColorsConfig().textWhite1(),
                          fontSize: 20.0.sp,
                          fontWeight: FontWeight.w400),
                    ),
                    Html(
                      data: agreementData['paid'],
                    ),
                  ],
                ),
              ),
